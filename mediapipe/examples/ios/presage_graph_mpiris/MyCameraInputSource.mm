...
// The purpose of this script is to modify the MPPCameraInputSource to
// a custom camera handler called MyCameraInputSource which will
// lock autoexposure and if possible white balancing and gain

#import "MyCameraInputSource.h"

#import <UIKit/UIKit.h>

@interface MyCameraInputSource () <AVCaptureVideoDataOutputSampleBufferDelegate,
                                        AVCaptureDepthDataOutputDelegate>
@end

@implementation MyCameraInputSource {
